				...
				<tr>					
					<td style="vertical-align:top;">	
						<g:if test="${term.value['type'] == 'numeric'}">
							<g:render template="categoryRangeWest" model="[termName:term.key, termDisplayName:term.value.displayName]" />
						</g:if>
						<g:elseif test="${term.value['type'] == 'string_autocomplete'}">
							<g:render template="categoryAutocompleteWest" model="[termName:term.key, termDisplayName:term.value.displayName]" />
						</g:elseif>
						<g:else>
