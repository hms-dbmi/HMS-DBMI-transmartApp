...
<head>
	...
	<title>Clinical Note Explorer</title>
...
<script type="text/javascript">
	...
	GLOBAL = {
      ...
      explorerType: 'clinicalNoteExplorer'
	};
...
<div id="header-div"><g:render template="/layouts/commonheader" model="['app':'clinicalnoteexplorer']" /></div>
<div id="main"></div>
