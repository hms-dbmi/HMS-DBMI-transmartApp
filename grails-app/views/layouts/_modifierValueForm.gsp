...
<g:form>
	...
	<input id='chkEnableModifierValues' type='checkbox' onclick='toggleValueConstraint();' /> Click here to constrain by value

	<select id='modifierValueList' multiple disabled>
		
	</select>
	
	<input type='button' value='Done' id="btnModifierValuesDone">
