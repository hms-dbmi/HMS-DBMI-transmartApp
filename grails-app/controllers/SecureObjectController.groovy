...
class SecureObjectController {
	...
	def list = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"List Secure Objects", accesstime:new Date() ).save()
	...
	def show = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Show Secure Object", accesstime:new Date(), eventmessage: "Secure Object ID - " + params.id  ).save()
	...
	def delete = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Delete Secure Object", accesstime:new Date(), eventmessage: "Secure Object ID - " + params.id  ).save()
	...
	def edit = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Edit Secure Object", accesstime:new Date(), eventmessage: "Secure Object ID - " + params.id  ).save()
	...
	def update = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Update Secure Object", accesstime:new Date(), eventmessage: "Secure Object ID - " + params.id  ).save()
	...
	def create = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Secure Object Created", accesstime:new Date()  ).save()
	...
	def save = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Secure Object Saved", accesstime:new Date()  ).save()
