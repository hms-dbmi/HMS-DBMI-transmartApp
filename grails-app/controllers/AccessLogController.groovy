...
class AccessLogController {
	...
	def list = {
		...
		def filter = session.getAttribute("accesslogFilter");
		if(filter==null){
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Access Log Viewed", accesstime:new Date()).save()
	...
	def export =	{
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Access Log Exported", accesstime:new Date()).save()
	...
	def show = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Access Log Instance View", accesstime:new Date()).save()
	...
	def delete = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Access Log Instance Delete", accesstime:new Date()).save()
	...
	def edit = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Access Log Instance Edit", accesstime:new Date()).save()
	...
	def update = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Access Log Instance Update", accesstime:new Date()).save()
	...
	def create = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Access Log Instance Create", accesstime:new Date()).save()
	...
	def save = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Access Log Instance Saved", accesstime:new Date()).save()
