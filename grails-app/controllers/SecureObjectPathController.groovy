...
class SecureObjectPathController {
	...
	def list = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Secure Object Path List", accesstime:new Date()).save()
	...
	def show = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Show Secure Object Path", accesstime:new Date(), eventmessage: "Secure Object Path ID - " + params.id  ).save()
	...
	def delete = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Delete Secure Object Path", accesstime:new Date(), eventmessage: "Secure Object Path ID - " + params.id  ).save()
	...
	def edit = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Edit Secure Object Path", accesstime:new Date(), eventmessage: "Secure Object Path ID - " + params.id  ).save()
	...
	def update = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Update Secure Object Path", accesstime:new Date(), eventmessage: "Secure Object Path ID - " + params.id  ).save()
	...
	def save = {
		...
		new AccessLog(username: springSecurityService.getPrincipal().username, event:"Save Secure Object Path", accesstime:new Date(), eventmessage: "Secure Object Path ID - " + params.id  ).save()
