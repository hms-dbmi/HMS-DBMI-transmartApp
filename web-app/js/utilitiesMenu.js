...
function createUtilitiesMenu(helpURL, contact, appTitle, basePath, buildVer, css, currentUserName)
{
	...
	var utilityMenu = new Ext.menu.Menu(
	{
	    ...
	    items : [
	             ...
	             {text : 'User Profile',href : basePath+'/user'},
	             {text : "User's Guide", href: GLOBAL.UserGuideURL},
	             //{  text : 'User Account', href : basePath+'/user/useraccount' },
	             '-',
	             //{ text : 'Login',href : basePath+'/login/forceAuth'},'-',
	             {text : 'Log Out', href : basePath+'/logout'}
	            ]
	});
